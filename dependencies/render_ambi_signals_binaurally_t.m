function [out_lr] = render_ambi_signals_binaurally_t(ambi_signals, head_orientation_azimuth, N)
% hrir_type: 'HRIR_L2702' or 'HRIR_sphere_2702'
%
...
% Download from here: https://zenodo.org/record/3928297
hrtfs_sofa = SOFAload('resources/HRIR_L2702.sofa');

% extract irs
hrirs_l = squeeze(hrtfs_sofa.Data.IR(:, 1, :)).';
hrirs_r = squeeze(hrtfs_sofa.Data.IR(:, 2, :)).';

% extract incidence angles
azi_hrtfs =        hrtfs_sofa.SourcePosition(:, 1).' / 180 * pi;
col_hrtfs = pi/2 - hrtfs_sofa.SourcePosition(:, 2).' / 180 * pi; % ele to col
